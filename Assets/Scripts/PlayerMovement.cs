...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        trenutniCoins = PlayerPrefs.GetInt("Coins");
        Coins.text = "COINS: " + PlayerPrefs.GetInt("Coins",trenutniCoins);
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.tag == "Death")
        {
            ...
            RB.constraints = RigidbodyConstraints.FreezeAll; //iako se sve okolo usporava, igracu se freeza pozicija
            LifeHealth.health -= 1;
    ...
    private void Update()
    {
        ...
        PlayerPrefs.SetInt("Coins", trenutniCoins);
    }
    ...
    {
        float x = Input.GetAxis("Horizontal") * Time.fixedDeltaTime * brzina;
